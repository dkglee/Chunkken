...
void AMyGameMode::BeginPlay()
{
	...
	ABaseCharacter* Player1 = GetWorld()->SpawnActor<ABaseCharacter>(HwoarangClass, Player1Location, SpawnRotation);
	if(Player1)
	{
	...
	ABaseCharacter* Player2 = GetWorld()->SpawnActor<ABaseCharacter>(SteveFoxClass, Player2Location, SpawnRotation);
	if(Player2)
	{
